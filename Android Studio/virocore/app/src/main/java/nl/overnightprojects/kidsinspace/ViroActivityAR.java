 ...
 */
package nl.overnightprojects.kidsinspace;
...
public class ViroActivityAR extends Activity implements ARScene.Listener {
    ...
    private String[] spaceMetallicAssets = {"venus_metallic.png", "empty.png"};
    private String[] spaceNormalMapAssets = {"venus_normal_map.png", "moon_normal_map.png"};

    private enum CAR_MODEL{
        VENUS("venus_texture.png",         new Vector(231,231,231)),
        MOON("moon_texture.png",     new Vector(19, 42, 143));
    ...
    private void initCarModel(Node groupNode, final String marker) {
        ...
        fbxCarNode.loadModel(Uri.parse("file:///android_asset/icosphere001.obj"), Object3D.Type.OBJ, new AsyncObject3DListener() {
            @Override
    ...
    */
    ...
    private Material preloadCarColorTextures(Node node, String marker){
        ...
        // get Firebase int for which marker
        ...
        switch (index){
            case 0:
                material.setDiffuseTexture(mCarColorTextures.get(CAR_MODEL.VENUS));
                break;
            case 1:
                material.setDiffuseTexture(mCarColorTextures.get(CAR_MODEL.MOON));
                break;
            case 2:
                material.setDiffuseTexture(mCarColorTextures.get(CAR_MODEL.MOON));
                break;
