...
public class StudentLoginActivityTEMP extends Activity {
    ...
    private void checkCodeWithFireBase(){
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(codeInput.toString() == code){
                    goToVRActivity();
                }
                else{
                    Toast.makeText(StudentLoginActivityTEMP.this, "The code " + codeInput.toString() + " is wrong. Try again.", Toast.LENGTH_SHORT).show();
                }
            }
